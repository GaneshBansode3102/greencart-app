...
const Cart = () => {
    const { setCartItems, axios, products, navigate, currency, addToCart, cartItems, removeFromCart, getCartCount, getCartAmount, updateCartItem, user } = useAppContext();
    ...
    const [paymentAddress, setpaymentAddress] = useState("COD")
    ...
    const getUserAddress = async () => {
        try {
            ...
            if (data?.success && Array.isArray(data.addresses)) {
                ...
                toast.error(data?.message || "No address found");
            }
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress.city},${selectedAddress.city},${selectedAddress.state},${selectedAddress.country}` : "No address found"}</p>
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primary-dull transition">
                    {paymentOption === "COD" ? "Place Order" : "Proceed To Chekout"}
                </button>
            </div>
        </div>
    ) : null
